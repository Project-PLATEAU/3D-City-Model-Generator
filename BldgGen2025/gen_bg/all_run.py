...
def generate_city_assets(
    ...
    Inputs:
        input_path       : Path to orthoimage (GeoTIFF) or GeoJSON
...
if __name__ == "__main__":
    # tif_path = r"./data/test_data/img/53395538.tif"
    #
    # # Case 1: Use LOD2
    ...
    input_path = r"/fast/zcb/code/cbzhao/svi2d/data/NTT/route2/akabane_route2.geojson"
    generate_city_assets(input_path, lod=1, lod2_obj_path=None)
