...
def predict_vegetation_to_shp(
    ...
    *,
    ...
    """
    # Set default onnx_path if not provided
    if onnx_path is None:
        onnx_path = os.path.join(_DATA_DIR, "model", "vegetation_seg.onnx")
...
def sample_trees_and_export_obj(
    ...
    *,
    ...
    if vege_root is None:
        vege_root = os.path.join(_DATA_DIR, "vegetation", "SolitaryVegetationObject")
    if vege_label_csv is None:
        vege_label_csv = os.path.join(_DATA_DIR, "vegetation", "tree_label.csv")
...
#     img_path = r"C:\zcb\data\project\plateau\draft\14100_yokohama-shi_city_2023_ortho_1_op\14100_yokohama-shi_city_2023_ortho_1_op\53391531.tif"
#     out_dir = r"C:\zcb\code\python\gen_bg\draft\vegetation"
#
#     result = generate_vegetation_assets(
#         img_path=img_path,
#         lod=2,                 # 1/2/3
#         out_dir=out_dir,
#         save_shp=False,        # default: not export vegetation.shp
#         save_obj=True,         # default: export gen_vegetation.obj
#         save_gml=True,         # default: export gen_vegetation.gml
#         colorize_obj=True,     # turn off if you want geometry-only OBJ
#     )