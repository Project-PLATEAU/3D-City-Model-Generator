...
data_root = '/home/mdxuser/Desktop/jupyter/InternImage/segmentation/dataset/Road'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        data_root=
        '/home/mdxuser/Desktop/jupyter/InternImage/segmentation/dataset/Road',
...
resume_from = '/fast/jupyter/InternImage/segmentation/work_dirs/Road/20240202/iter_40000.pth'
workflow = [('train', 1)]
...
checkpoint_config = dict(by_epoch=False, interval=600, max_keep_ckpts=1)
evaluation = dict(
    interval=600, metric=['mIoU'], pre_eval=True, save_best='mIoU')
pretrained = '/fast/jupyter/InternImage/segmentation/checkpoint_dir/seg/upernet_internimage_l_640_160k_ade20k.pth'
work_dir = 'work_dirs/Road/20240202'
gpu_ids = range(0, 4)
auto_resume = False
